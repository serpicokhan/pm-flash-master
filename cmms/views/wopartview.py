        ...
        if(not wopart.manager_confirmed):
            ...
            if any(group in user_groups for group in ['manager1']):
                ...
                if any(group in user_groups for group in ['manager2']):
                  ...
                  send_message_to_group_x(request,"anbar",f"قطعه {wopart.woPartStock} مربوط به درخواست شماره {wopart.woPartWorkorder.id} تامین شد.",f"/WorkOrder/{wopart.woPartWorkorder.id}/details")
