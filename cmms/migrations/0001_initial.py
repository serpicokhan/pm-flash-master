# Generated by Django 3.2.6 on 2021-11-30 14:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taskMetrics', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmms.metercode', verbose_name='واحد اندازه گیری')),
            ],
            options={
                'db_table': 'tasks',
            },
        ...
        migrations.AddField(
            model_name='part',
            name='partCategory',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dasdadassa', to='cmms.partcategory', verbose_name='دسته بندی'),
        ),
        migrations.CreateModel(
            name='MiscCost',
            fields=[
