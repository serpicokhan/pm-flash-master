# Generated by Django 3.2.6 on 2023-06-10 14:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('taskTypes', models.IntegerField(blank=True, choices=[(1, 'عمومی'), (2, 'متنی'), (3, 'متریک'), (4, 'بازرسی')], null=True, verbose_name='انتخاب نوع فعالیت')),
                ('taskDescription', models.CharField(blank=True, max_length=200, null=True, verbose_name='توضیحات')),
                ('taskResult', models.FloatField(blank=True, max_length=50, null=True, verbose_name='نتیجه')),
                ...
                ('taskDateCompleted', models.DateField(blank=True, null=True, verbose_name='تاریخ تکمیل')),
                ...
                ('taskCompletionNote', models.CharField(blank=True, max_length=200, null=True, verbose_name='یادداشت تکمیلی')),
                ('task_inspection', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workInstructions', models.CharField(blank=True, max_length=200, null=True, verbose_name='دستورالعمل')),
                ...
                ('timeCompleted', models.TimeField(blank=True, default=datetime.datetime.now, null=True, verbose_name='زمان تکمیل(تخمین')),
                ...
                ('completionNotes', models.CharField(blank=True, max_length=250, null=True, verbose_name='اطلاعات تکمیلی')),
                ...
                ('adminNote', models.CharField(blank=True, max_length=250, null=True, verbose_name='توضیحات مدیر')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taskTemplateMetrics', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmms.assetmetertemplate', verbose_name='واحد اندازه گیری')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shMeterReadingMetrics', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='schedule_shMeterReadingMetrics', to='cmms.assetmetertemplate', verbose_name='واحد اندازه گیری')),
                ('shMeterReadingWhenMetric', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sch_meter_when', to='cmms.assetmetertemplate', verbose_name='واحد اندازه گیری')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PurchaseRequestAsset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ImpactedAsset', to='cmms.asset', verbose_name='تجهیز')),
                ('PurchaseRequestAssetMakan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ImpactedLocation', to='cmms.asset')),
                ...
                ('PurchaseRequestPartName', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='RequestedPart', to='cmms.part', verbose_name='مشخصات قطعه')),
                ('PurchaseRequestRequestedUser', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PurchaseRequestdUser', to='cmms.sysuser', verbose_name='کاربر درخواست کننده')),
                ('PurchaseRequestWO', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ImpactedWO', to='cmms.workorder', verbose_name='درخواست مربوطه')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('assetMeterMeterReading', models.FloatField(default=0.0, verbose_name='مقدار')),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ...
                ('assetMeterMeterReadingUnit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmms.assetmetertemplate', verbose_name='واحد اندازه گیری')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('assetCadFile', models.FileField(max_length=200, upload_to='documents/%Y/%m/%d')),
                ('assetCadFiledateAdded', models.DateTimeField(auto_now_add=True)),
                ('assetCadFileAssetId', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='cmms.asset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ShiftTypes', models.CharField(blank=True, choices=[('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=1, null=True, verbose_name='شیفت')),
                ('assetStartKilometer', models.DecimalField(decimal_places=3, default=0, max_digits=15, verbose_name='کیلومتر پایان شیفت قبل')),
                ('assetEndKilometer', models.DecimalField(decimal_places=3, default=0, max_digits=15, verbose_name='کیلومتر پایان شیفت جاری')),
                ('assetTotlaKilometer', models.DecimalField(decimal_places=3, default=0, max_digits=15, verbose_name='کیلومتر تولید')),
                ('assetStartTime', models.DecimalField(decimal_places=3, default=0, max_digits=10, verbose_name='ساعت پایان شیفت قبل')),
                ('assetEndTime', models.DecimalField(decimal_places=3, default=0, max_digits=10, verbose_name='ساعت پایان شیفت جاری')),
                ('assetTotalTime', models.DecimalField(decimal_places=3, default=0, max_digits=10, verbose_name='ساعت تولید')),
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('assetName', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ringAmar', to='cmms.asset', verbose_name='تجهیز')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('BMGGroup', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmms.batchmetergroup', verbose_name='گروه')),
                ('BMGTemplate', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmms.assetmetertemplate', verbose_name='مترینگ')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('BMGAsset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmms.asset', verbose_name='دارایی')),
                ('BMGGroup', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmms.batchmetergroup', verbose_name='گروه')),
            ],
            options={
                'db_table': 'bmgasset',
