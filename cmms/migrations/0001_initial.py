# Generated by Django 2.0.2 on 2021-05-07 07:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isEM', models.BooleanField(default=False, verbose_name='درخوسات ناخواسته یا EM')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cmms.OfflineStatus', verbose_name='وضعیت'),
        ),
        migrations.AddField(
            model_name='assetlife',
