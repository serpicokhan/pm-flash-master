...
class WorkOrder(models.Model):
    ...
    workInstructions = models.CharField("دستورالعمل",max_length = 200,null=True,blank=True)
    ...
    #Completion Notes
    completionNotes = models.CharField("اطلاعات تکمیلی",max_length = 250,null=True,blank=True)
    ...
    adminNote  = models.CharField("توضیحات مدیر",max_length = 250,null=True,blank=True)
