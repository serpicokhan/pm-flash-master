...
urlpatterns = [
   ...
   #url(r'^$',dashboard,name='dashboard'),
    ...
    url(r'^MyWO/$',list_my_workorder,name='list_my_workorder'),
    ...
    url(r'^WorkOrder/(?P<woId>\d+)/SetStatus/(?P<status_code>\d+)$', set_wo_status, name='set_wo_status'),
    ...
    url(r'^WorkOrder/Copy/(?P<ids>\d+(?:,\d+)*)$', wo_copy, name='wo_copy'),
     ...
     url(r'^TaskGroupFile/(?P<Id>\d+)/basic-upload/$', TaskGroupBasicUploadView.as_view(), name='taskgroupbasic_upload'),
      ...
      url(r'^notification/list$',get_notifications_cmms,name='get_notifications_cmms'),
         ...
         # url(r'^BOMGroup/(?P<id>\d+)/Cancel/$', bomgroupCancel, name='bomgroupCancel'),
          ...
          url(r'^BusinessPart/(?P<woId>\d+)/listBusinessPart/$', js_list_businessPart, name='js_list_businessPart'),
           ...
           url(r'^PurchaseRequest/$',list_purchaseRequest,name='list_purchaseRequest'),
            ...
            url(r'^api/v1/RelateWo/(?P<asset_id>\d+)/$', views.RecentWorkOrderByAsset.as_view(), name='RecentWorkOrderByAsset'),
