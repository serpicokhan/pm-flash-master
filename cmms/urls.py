...
urlpatterns = [
   ...
   #url(r'^$',dashboard,name='dashboard'),
    ...
    url(r'^WorkOrder/BulkComplete/(?P<ids>\d+(?:,\d+)*)$', bulk_complete_wo, name='bulk_complete_wo'),
     ...
     url(r'^TaskGroupFile/(?P<Id>\d+)/basic-upload/$', TaskGroupBasicUploadView.as_view(), name='taskgroupbasic_upload'),
      ...
      url(r'^WoNotify/(?P<woId>\d+)/listWoNotify/$', js_list_woNotify, name='js_list_woNotify'),
       ...
       url(r'^Schedule/(?P<woId>\d+)/listSchedule/$', js_list_schedule, name='js_list_schedule'),
        ...
        url(r'^BOMGroupAsset/SelectAsset$', bomGroupAsset_asset_select, name='bomGroupAsset_asset_select'),
        url(r'^BOMGroupAsset/AssetPage$', LoadPageAssetBomGroupAsset, name='LoadPageAssetBomGroupAsset'),
        ...
        url(r'^api/v1/Stock/(?P<id>\d+)/$',stock_detail_collection, name='stock_detail_collection'),
         ...
         url(r'^BOMGroup/Search/$', BOM_search, name='BOM_search'),
         ...
         # url(r'^BOMGroup/(?P<id>\d+)/Cancel/$', bomgroupCancel, name='bomgroupCancel'),
          ...
          url(r'^BusinessPart/(?P<woId>\d+)/listBusinessPart/$', js_list_businessPart, name='js_list_businessPart'),
           ...
           url(r'^User/Running$', list_user_by_status, name='list_user_by_status'),
           ...
           url(r'^PurchaseRequest/$',list_purchaseRequest,name='list_purchaseRequest'),
            ...
            url(r'^api/v1/UploadWoFile/$', views.MultipleFilesUploadView.as_view(), name='MultipleFilesUploadView'),
            ...
            path('fcm/', views.FCMToken.as_view(), name='get_fcm_token'),  # <-- And here
